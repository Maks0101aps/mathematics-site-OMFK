...
export const FIGURES: Figure[] = [
  {
    ...
    lifeExplanation: "Кубічну форму мають ігрові кубики, коробки, блоки конструктора та кубик Рубіка.",
  ...
  },
  {
    ...
    realObject: "книга або цеглина",
    lifeExplanation: "Паралелепіпед легко побачити у книжках, цеглинах, шафах та коробках від телефонів.",
